...
<div class="flex justify-center items-center h-screen">
    ...
    <form class="px-4 py-3 mb-8 w-1/3 bg-white rounded-lg shadow-xl" action="{{ route('password.change') }}" method="post">
        @csrf
        @method('put')
        <div class="flex justify-between items-center">
            <span class="text-lg font-bold mr-auto">Change Password</span>
        ...
        <button type="submit" class="py-2 px-3 my-3 rounded-md bg-blue-600 text-white font-semibold">Change Password</button>
    </form>
</div>
@endsection